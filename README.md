...
* [`src/pain_app_mobile/styles.cljs`](src/pain_app_mobile/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/pain_app_mobile/`](src/pain_app_mobile/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/pain_app_mobile/core.cljs): contains the SPA entry point, `init`
* [`test/pain_app_mobile/`](test/pain_app_mobile/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `pain-app-mobile` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/pain_app_mobile/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns pain-app-mobile.example
  (:require [pain-app-mobile.config :as config])
